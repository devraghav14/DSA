// Leetcode Problem No : 295 - Find Median from Data Stream(Hard)
...
public:
    ...
    void addNum(int num)
    {
        ...
        // Step 2: Balance the heaps by moving the top of maxHeap to minHeap
        minHeap.push(maxHeap.top());
        maxHeap.pop();

        // Step 3: If minHeap has more elements, move the top back to maxHeap
