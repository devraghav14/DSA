// GfG Problem : Number of Distinct Islands (Medium)
...
private:
    void dfs(int row, int col, vector<vector<int>> &visited, vector<vector<int>> &grid,
             vector<pair<int, int>> &vect, int row0, int col0)
    {
        visited[row][col] = 1;
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            {
                dfs(nRow, nCol, visited, grid, vect, row0, col0);
            }
        }
    }
